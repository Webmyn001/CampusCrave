  ...
  return (
    <section className="max-w-7xl mx-auto py-12 px-4">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-2">
          <button 
            ...
            className="p-2 bg-white border border-gray-200 hover:bg-red-50 rounded-full text-red-500 transition-colors shadow-sm"
          >
      ...
      <div className="relative">
                ...
                listings.map((item) => (
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <span className="absolute top-3 left-3 bg-red-100 text-red-600 px-3 py-1 rounded-full text-xs font-semibold shadow-sm flex items-center gap-1">
                        <FiAlertTriangle className="w-4 h-4" /> {item.urgency || 'Urgent'}
                      </span>
                    </motion.div>
        ...
        <div className="pointer-events-none absolute inset-y-0 left-0 w-12 bg-gradient-to-r from-red-50 to-transparent"></div>
        <div className="pointer-events-none absolute inset-y-0 right-0 w-12 bg-gradient-to-l from-red-50 to-transparent"></div>
      </div>

      <div className="text-center mt-8">
        <Link 
          to="/urgentlistings" 
          className="inline-block bg-gradient-to-r from-red-500 to-orange-400 text-white px-8 py-3 rounded-full font-medium shadow-md hover:shadow-lg transition-shadow hover:scale-105 transform"
        >
