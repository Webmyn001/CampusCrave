      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            >
              <span className="bg-gradient-to-r from-yellow-600 via-amber-600 to-orange-600 bg-clip-text text-transparent">Premium</span>
              <span className="text-gray-800 font-light">Listings</span>
            </motion.h1>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Exclusive high-quality items from your campus community
            </p>
          </div>
          ...
          >
            <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-200">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search premium listings by item name..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-sm bg-gray-50 focus:bg-white transition-all"
                />
                <button
                  onClick={() => setShowFilterModal(true)}
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 p-1.5 bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-white rounded-md transition-all duration-300 hover:scale-105"
                >
            ...
            >
              ...
              >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <select
                        ...
                        className="px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
                      >
                  ...
                  <div className="bg-gray-50 rounded-xl p-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div className="text-center p-3 bg-yellow-50 rounded-lg">
                        ...
                        <div className="text-yellow-500">Filtered Results</div>
                      </div>
                      <div className="text-center p-3 bg-amber-50 rounded-lg">
                        <div className="font-bold text-amber-600 text-lg">{premiumListingsData.length}</div>
                        <div className="text-amber-500">Total Listings</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3 p-6 border-t border-gray-200">
                  ...
                  <button
                    onClick={() => setShowFilterModal(false)}
                    className="flex-1 bg-gradient-to-r from-yellow-500 to-amber-600 text-white py-3 rounded-xl font-semibold hover:from-yellow-600 hover:to-amber-700 transition-colors"
                  >
                    Apply Filters
                  </button>
                </div>
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <div className="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-xl shadow-sm p-4 border border-yellow-100">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  <span className="bg-gradient-to-r from-yellow-500 to-amber-600 text-white px-3 py-1 rounded-full text-sm font-semibold shadow-md">
                    {loading ? '...' : filteredListings.length} results
                  </span>
                  <span className="text-xs text-gray-500 bg-white px-2 py-1 rounded-full">
                    of {premiumListingsData.length} total
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none bg-white border-2 border-yellow-200 rounded-lg px-4 py-2 pr-8 text-sm font-medium text-gray-700 focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-all duration-200 shadow-sm hover:shadow-md cursor-pointer"
                  >
                  ...
                  <ChevronDown className="absolute right-2 top-1/2 transform -translate-y-1/2 w-4 h-4 text-yellow-500 pointer-events-none" />
                </div>
              </div>
            </div>
          </div>
                    ...
                    >
                      <div className="relative overflow-hidden">
                        ...
                        <div className="absolute bottom-2 left-2">
                          <span className="bg-yellow-500 text-white px-2 py-0.5 rounded-full text-xs font-medium flex items-center gap-1">
                      ...
                      <div className="p-3">
                        <h3 className="font-semibold text-sm text-gray-800 mb-2 line-clamp-2 leading-tight group-hover:text-yellow-600 transition-colors">
                        ...
                        <div className="space-y-1 mb-3">
                          <div className="flex items-center gap-1.5 text-xs text-gray-600">
                            ...
                            <span className="line-clamp-1">Condition: {item.condition || "Excellent"}</span>
                          </div>
                          <div className="flex items-center gap-1.5 text-xs text-gray-600">
                            <User className="w-3 h-3 text-indigo-500" />
                            <span className="line-clamp-1">{item.sellerInfo?.name || "Premium Seller"}</span>
                          </div>
                        </div>
                        ...
                        <Link 
                          ...
                          state={{ product: item }}
                          className="block w-full bg-gradient-to-r from-yellow-500 to-amber-600 text-white py-2 rounded-lg font-medium hover:from-yellow-600 hover:to-amber-700 transition-all duration-300 text-xs text-center flex items-center justify-center gap-1"
                        >
        ...
        <motion.button
          ...
          onClick={() => setShowFilterModal(true)}
          className="fixed bottom-6 right-6 lg:hidden bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-white p-3 rounded-full shadow-lg z-40 transition-all duration-300 hover:scale-110"
        >
